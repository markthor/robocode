...
public class Wave {
	...
	private boolean estimated;           // can happen if we don't know exact time due to missed scans
	
	public Wave(Snapshot defenderSnapshot, Snapshot attackerSnapshot, double bulletPower, long bulletFiredTime, boolean estimated) {
	...
	public FactorIndexer getFactorIndexer() {
		return opponentWave? Resources.getMyFactorIndexer() : Resources.getOpponentFactorIndexer();
	}
