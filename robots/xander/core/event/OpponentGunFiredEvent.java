...
public class OpponentGunFiredEvent {
	...
	private long time;
	private boolean estimated; // can happen if scan missed due to skipped turns or otherwise
	
	public OpponentGunFiredEvent(double power, Snapshot mySnapshot, Snapshot opponentSnapshot, long time, boolean estimated) {
		this.power = power;
