...
public class REMHitSets {
	...
	public static String[] getLTargetingSet() {
		String[] set = new String[] {
				"alex.Diabolo5",
				"amk.ShizzleStiX.ShizzleStiX",
				"ar.QuantumChromodynamics",
				"bayen.UbaMicro",
				"bigpete.Stewie",
				"bvh.micro.Freya",
				"deewiant.Anomaly",
	...
	public static String[] getHTargetingSet() {
		String[] set = new String[] {
				"davidalves.net.DuelistNano",
				"dcs.Eater_of_Worlds_Mini",
				"elloco.Kabuto",
				"fm.mammillarias",
				"gwah.GBotMarkIV",
				"jaybot.bots.Oddball",
				"jep.nano.Hotspur",
				"jep.Terrible",
				"kawigi.sbf.Barracuda",
				"kawigi.sbf.FloodNano",
				"kjc.MailManX",
				"krillr.mini.JointStrike",
				"myl.micro.Predator",
				"m3thos.Eva00",
				"Noran.BitchingElk",
				"ntc.Swim",
