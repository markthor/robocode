...
public class M1TBulletTargeter implements BulletTargeter {
	...
	public double getAim(Wave wave) {
		...
		Snapshot snap2 = Resources.getSnapshotHistory().getSnapshot(
				wave.getInitialAttackerSnapshot().getName(), 
				wave.getInitialAttackerSnapshot().getTime(), true);
		double hd = snap2.getHeadingRoboRadians()-snap.getHeadingRoboRadians();
