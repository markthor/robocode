...
//	};
	...
	public boolean applies() {
		...
		if (robotProxy.getEnergy() < 30 || (robotProxy.getEnergy() < 50 && robotProxy.getRoundNum() > 2)) {
			energyCutoff = true;
		}
		...
		boolean applies = !isX5
			...
			&& !energyCutoff  // 2013-11-16 -- new condition for halting (halting current round only) when shielding is not working well enough (might can be feathered into another condition with more research)
