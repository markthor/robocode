...
public class Line extends Line2D.Double {
	...
	public static final Line projection(Vector p, double angle, double dist) {
		Line line = new Line();
		line.x1 = p.x;
		line.y1 = p.y;
		line.x2 = p.x + Math.sin(angle) * dist;
		line.y2 = p.y + Math.cos(angle) * dist;
		return line;
	}

	public static final Line projection(Vector p, double angle, double dist1, double dist2) {
		Line line = new Line();
		line.x1 = p.x + Math.sin(angle) * dist1;
		line.y1 = p.y + Math.cos(angle) * dist1;
		line.x2 = p.x + Math.sin(angle) * dist2;
		line.y2 = p.y + Math.cos(angle) * dist2;
		return line;
	}
